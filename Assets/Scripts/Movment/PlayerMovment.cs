...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    private KeyCode LoadKey(string keyName, string defaultKey) {
        ...
        return KeyCode.Space; // There was an error without it, it has to return something in case it can't parse both the saved and default key
    }

    private void Update()
    {
        jumpKey = LoadKey("JumpKey", "Space"); // Load the key from PlayerPrefs
        crouchKey = LoadKey("CrouchKey", "LeftControl"); // Load the key from PlayerPrefs
        slowWalkKey = LoadKey("SlowWalkKey", "LeftShift"); // Load the key from PlayerPrefs
        // ground check
